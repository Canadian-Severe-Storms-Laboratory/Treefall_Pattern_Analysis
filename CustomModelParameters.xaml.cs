    ...
    public partial class CustomModelParameters : UserControl
    {
        ...
        public Params GetParams()
        {
            return new Params
            {
                ...
                phi = phiSlider.Value,
                n = (int)nSlider.Value,
                modelType = modelSelectionBox.SelectedIndex,
        ...
        private void paramSliderChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            vrLabel.Content = vrSlider.Value.ToString("N3");
            vtLabel.Content = vtSlider.Value.ToString("N3");
            vsLabel.Content = vsSlider.Value.ToString("N3");
